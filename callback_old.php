...
if($ResCode == '0')
{
	...
	&& isset($_POST['FinalAmount']) && $_POST['FinalAmount'] != "" && isset($_POST['SaleReferenceId']) && $_POST['SaleReferenceId'] != "" && isset($_POST['CardHolderInfo']) && $_POST['CardHolderInfo'] != ""){
		...
		$CardHolderInfo = $purifier->purify($_POST['CardHolderInfo']);
			...
			$url = 'https://modirsanapi.mcci.local/payments/verify';
			$body = '{
				"orderId": '.$SaleOrderId.',
			...
			if( isset( $obj->{'code'} ) &&  $obj->{'code'} == '0'){ // if verify ok				
				$url = 'https://modirsanapi.mcci.local/payments/settle';
				$body = '{
					"orderId": '.$SaleOrderId.',
					"saleOrderId": '.$SaleOrderId.',
					"saleReferenceId": '.$SaleReferenceId.'
      ...
      <div class="col-md-6 mx-auto mt-5">
         <div class="payment">
            ...
            <div class="content">
               ...
               <p>مبلغ پرداختی به اعتبار کارگزار اضافه خواهد شد.</p>
         ...
         <div class="payment">
            ...
            <div class="content">
               ...
               <p><?php
				...
				?></p>
               <a class="error" href="https://chclub.mci.ir/pages/PayRequest">بازگشت</a><br />
			   <b id="progresslabel"></b><br />
			   <progress value="0" max="25" id="progressBar"></progress>
            </div>
...
<?php
	if(isset($_POST['RefId']) && $_POST['RefId'] != "" && isset($_POST['SaleOrderId']) && $_POST['SaleOrderId'] != "" ){
		    ...
		    $ResCode = $purifier->purify($_POST['ResCode']);
				...
				$url = 'https://modirsanapi.mcci.local/payments/cancel';
				$body = '{
					"orderId": '.$SaleOrderId.',
					"saleOrderId": '.$SaleOrderId.',
					"resCode": '.$ResCode.'
